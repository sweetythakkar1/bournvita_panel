                        ...
                        <br/>
                            <div class="login-box card">
                                <div class="card-body">
                                    ...
                                    <?php
                                    $form_attr = array("class" => "form-horizontal form-material", "id" => "forgot_form", "name" => "forgot_form");
                                    echo form_open("forgot-password", $form_attr);
                                    ?>
                                    <h2 class="box-title m-b-40 text-center">Forgot Password</h2>
                                    <div class="form-group ">
                                        <div class="col-xs-12">
                                            <input class="form-control" value="" type="email" name="email" required="" placeholder="Email"> 
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <a href="<?php echo site_url('auth') ?>" id="to-recover" class="text-dark pull-right"><i class="fa fa-lock m-r-5"></i> Back to login.</a>
                                        </div>
                                    </div>
