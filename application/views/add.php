        ...
        <div class="col-lg-12">
            ...
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white"> Add New User <a href="<?php echo site_url('admin/user/all_user_list') ?>" class="btn btn-info pull-right"><i class="fa fa-list"></i> All Users </a></h4>
                </div>
                <div class="card-body">
                    <form method="post" action="<?php echo site_url('admin/user/add') ?>" id="add_user" class="form-horizontal">
                        <div class="form-body">
                            <br>
                            <div class="row">
                                <div class="col-md-9">
