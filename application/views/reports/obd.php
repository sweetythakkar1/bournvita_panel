    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Voice Reports</h4> Total Record :  <?php echo isset($total_rows) ? $total_rows : 0; ?>
                        <hr/>

                        <?php
                        $form_attr = array("class" => "form-horizontal", "id" => "frm_search_download", "name" => "frm_search_download");
                        echo form_open_multipart("reports/obd_export", $form_attr);
                        ?>
                        <div class="row">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <a  class="btn btn-info  btn-xs"  href="<?php echo base_url("obd"); ?>" style="margin-top: 25px;"><i class="fa fa-refresh"></i></a>
                                </div>
                            </div>
                        </div>
                        <?php echo form_close(); ?>
