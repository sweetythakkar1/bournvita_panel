            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        echo form_open_multipart("reports/sms_export", $form_attr);
                        ?>
                        <div class="row">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <a  class="btn btn-info  btn-xs"  href="<?php echo base_url("sms-all"); ?>" style="margin-top: 25px;"><i class="fa fa-refresh"></i></a>
                                </div>
                            </div>
                        </div>
                        <?php echo form_close(); ?>
...
<script>
    ...
    function search_button() {
        $("#frm_search_download").attr("action", "<?php echo base_url('sms-all'); ?>");
